...
lessons.push(
  { slug:"monitoramento-da-compreensao",order:19,title:"Monitoramento da compreensão",collection:"fundamentos",minutes:9,objective:"Perceber rupturas de sentido e escolher um reparo.",explanation:["Compreender também é notar quando uma ligação se perdeu. Não conseguir explicar a função de uma frase é um sinal útil, não uma falha pessoal.","O reparo responde ao problema: reler uma relação específica, reduzir o trecho ou buscar uma definição. Depois, verifique o que mudou na interpretação."],example:"Ao não entender ‘esse resultado’, volte apenas até localizar qual experimento o produziu.",activity:"Marque três rupturas em um texto, nomeie o problema e teste um reparo diferente.",reviewQuestion:"O que torna uma releitura estratégica?",reviewAnswer:"Ela parte de uma dúvida específica e verifica se a interpretação melhorou.",references:["Baker (1984), Metacognitive Skills and Reading","Duke et al. (2021)"]},
  { slug:"argumentos-e-evidencias",order:20,title:"Argumentos e evidências",collection:"fundamentos",minutes:10,objective:"Separar tese, razão, evidência e limite.",explanation:["Uma afirmação diz o que o autor sustenta; razões explicam por quê; evidências oferecem apoio observável. Nem toda ilustração é prova suficiente.","Avalie relevância, suficiência e compatibilidade com a conclusão. Primeiro reconstrua a posição do autor; depois examine as ligações."],example:"Uma melhora após nova iluminação não prova sozinha que a iluminação foi a causa.",activity:"Faça quatro linhas para um artigo: tese, razão, evidência e limite.",reviewQuestion:"Por que um exemplo não prova uma regra geral?",reviewAnswer:"Porque pode ser isolado e não demonstrar que a relação se repete.",references:["Kuhn (1991), The Skills of Argument","Goldman et al. (2016)"]},
  { slug:"mapas-de-relacoes",order:21,title:"Mapas de relações",collection:"fundamentos",minutes:9,objective:"Representar relações conceituais com clareza.",explanation:["Um mapa útil mostra conceitos e o tipo de ligação: causa, contraste, parte, exemplo ou sequência. Setas sem rótulo escondem o raciocínio.","Construa após uma primeira compreensão e compare com o texto para localizar relações ausentes ou inventadas."],example:"Ligue chuva a solo saturado com ‘contribui para’, e não apenas com uma seta.",activity:"Crie seis conceitos, cinco ligações rotuladas e uma relação a confirmar.",reviewQuestion:"O que torna uma ligação informativa?",reviewAnswer:"Um rótulo que explicita como os conceitos se relacionam.",references:["Novak & Cañas (2008)","Fiorella & Mayer (2015)"]},
  { slug:"ritmo-progressivo",order:22,title:"Ritmo progressivo",collection:"pratica",minutes:9,objective:"Ajustar ritmo usando compreensão como guarda.",explanation:["Primeiro estabilize precisão e compreensão; depois teste um pequeno aumento. Após cada rodada, recupere a ideia central e duas relações.","Se a qualidade cair, retorne ao ritmo anterior. O resultado desejado é flexibilidade entre textos, não um único número máximo."],example:"Compare recordação em 130 e 145 ppm sem escolher automaticamente a leitura mais rápida.",activity:"Use a régua em três textos e aumente apenas 10 ppm por rodada.",reviewQuestion:"Quando manter um aumento de ritmo?",reviewAnswer:"Quando compreensão e retenção permanecem estáveis em mais de uma tentativa.",references:["Rayner et al. (2016)","Kuhn et al. (2010)"]},
  { slug:"perguntas-que-ensinam",order:23,title:"Perguntas que ensinam",collection:"pratica",minutes:9,objective:"Criar perguntas de relação e aplicação.",explanation:["Perguntas literais localizam fatos; relacionais conectam partes; de aplicação transferem uma ideia. Uma sequência equilibrada constrói profundidade.","Inclua foco e critério. ‘Quais evidências sustentam a tese?’ é mais verificável que ‘o que entendeu?’."],example:"Transforme ‘o que é erosão?’ em ‘como água e cobertura do solo interagem?’. ",activity:"Produza duas perguntas literais, duas relacionais e uma de aplicação.",reviewQuestion:"O que melhora uma pergunta de estudo?",reviewAnswer:"Foco claro, relação relevante e critério verificável.",references:["King (1992)","Rosenshine et al. (1996)"]},
  { slug:"comparacao-de-fontes",order:24,title:"Comparação de fontes",collection:"pratica",minutes:10,objective:"Integrar textos preservando diferenças.",explanation:["Identifique a pergunta comum e registre onde as fontes concordam, divergem ou tratam aspectos diferentes.","Verifique data, método, escopo e evidência. A síntese deve atribuir ideias e explicar por que cada diferença importa."],example:"Textos de anos e bairros diferentes podem não sustentar a mesma conclusão geral.",activity:"Faça uma matriz com afirmação, evidência, escopo e limite de duas fontes.",reviewQuestion:"Por que o escopo importa?",reviewAnswer:"Porque resultados de contextos diferentes podem não ser generalizáveis.",references:["Wineburg (1991)","Britt & Rouet (2012)"]},
  { slug:"plano-de-revisao-duravel",order:25,title:"Plano de revisão durável",collection:"memoria",minutes:9,objective:"Criar uma fila sustentável de revisões.",explanation:["Selecione ideias estruturantes, relações fáceis de confundir e conhecimentos que serão usados. Nem tudo precisa virar cartão.","Use perguntas específicas e respostas curtas. Itens dominados avançam; frágeis voltam cedo; sem valor podem ser arquivados."],example:"Troque ‘explique o capítulo’ por ‘quais condições sustentam o modelo?’. ",activity:"Extraia cinco perguntas de uma lição e reduza cada resposta ao essencial.",reviewQuestion:"O que caracteriza um bom item?",reviewAnswer:"Pergunta específica, resposta verificável e utilidade futura.",references:["Kang (2016)","Cepeda et al. (2006)"]},
  { slug:"ensinar-para-aprender",order:26,title:"Ensinar para aprender",collection:"memoria",minutes:10,objective:"Explicar para revelar o próprio entendimento.",explanation:["Explicar obriga a ordenar conceitos, explicitar relações e escolher exemplos. Isso expõe lacunas escondidas pela familiaridade.","Alterne definição, mecanismo, exemplo e limite. Depois confira a fonte e refaça sem consultar."],example:"Explique repetição espaçada: o que é, por que funciona, como ajustar e o que não garante.",activity:"Produza uma explicação de dois minutos, corrija uma lacuna e faça nova versão.",reviewQuestion:"Por que explicar revela mais que reler?",reviewAnswer:"Porque exige recuperar e organizar relações sem apoio imediato.",references:["Fiorella & Mayer (2015)","Chi et al. (1994)"]},
  { slug:"projeto-de-leitura-longa",order:27,title:"Projeto de leitura longa",collection:"memoria",minutes:11,objective:"Planejar e consolidar um livro extenso.",explanation:["Divida o projeto pela estrutura e dificuldade, com produtos claros. Ao fim de cada sessão, registre a pergunta respondida e uma questão aberta.","Em marcos maiores, produza uma síntese cumulativa e teste a lembrança depois de alguns dias. Ajuste o plano pelas evidências."],example:"Agrupe capítulos por argumento e defina uma síntese ao final de cada bloco temático.",activity:"Mapeie um livro, crie quatro marcos e um produto verificável para cada um.",reviewQuestion:"Qual é a função dos marcos?",reviewAnswer:"Manter continuidade, consolidar sínteses e permitir ajustes.",references:["Zimmerman (2002)","Alexander (2003)"]}
);
